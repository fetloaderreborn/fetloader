...
- Clone the repository with the command `git clone https://github.com/fetloaderreborn/fetloader | cd fetloader | git submodule update --init --recursive`
- Run `COMPILE.bat`
...
## Credits
- Reborn by [ToxicAngel](https://t.me/txxicangel)
