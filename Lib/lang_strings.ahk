...
if (language = "en") 
{
    ...
    global string_disclaimer := "If you've downloaded the loader from third-party sources, we decline all responsibility in case of infection of your system.`nMake sure that you downloaded the loader from trusted sources, such as: `nGithub."
...
if (language = "ru") 
{
    ...
    global string_disclaimer := "Если вы загрузили лоадер из непроверенных источников, мы полностью снимаем с себя ответственность в случае заражения вашей системы.`nУбедитесь, что загрузили лоадер с проверенных источников, таких как: `nGithub."
...
if (language = "ukr") 
{
    ...
    global string_disclaimer := "Якщо ви завантажили лоадер з неперевірених джерел - ми повністю знімаємо з себе відповідальність в разі зараження вашої системи будь-яким з вірусів.`nПереконайтеся що завантажили лоадер з перевірених джерел, таких як:`nGithub."
